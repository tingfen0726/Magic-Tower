...
namespace EnemyDatabase {
    const std::unordered_map<int, EnemyStats> Data = {
        ...
        {Config::ID::BIG_BAT,               {150, 65, 30, 12, 8, 0}},
        {Config::ID::ZOMBIE,                {300, 75, 45, 15, 10, 0}},
        {Config::ID::SKELETON_A,              {400, 90, 50, 17, 12, 0}},
        {Config::ID::STONE_MONSTER_B,       {500, 115, 65, 19, 15, 0}},
