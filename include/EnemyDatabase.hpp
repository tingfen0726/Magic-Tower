...
namespace EnemyDatabase {
    const std::unordered_map<int, EnemyStats> Data = {
        ...
        {Config::ID::DARK_MAGICIAN_1,       {1500, 830, 730, 80, 70, 0.33}},
        {Config::ID::DARK_MAGICIAN_2,       {2000, 1106, 973, 106, 93, 0.33}},
        {Config::ID::DARK_MAGICIAN_3,       {3000, 2212, 1946, 132, 116, 0.33}},
